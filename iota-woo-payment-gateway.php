...
function iota_cancel_order(){
	...
	update_option("woo_iota_order_status_".$order_id, "cancelled");
	$order->add_order_note( __( 'IOTA payment Timed Out. Order status of order '.$order_id.' changed from Pending payment to Cancelled.', 'payiota' ) );
